...
import SeoAgencyJson from "@/seojsonld/SeoAgencyJson";
...
const headingAnimateimages = [
  {
    src: "/social/chatgpt.webp",
    width: 80,
    height: 80,
    wrapperClass: "max-md:size-10 3xl:size-16",
  },
  {
    src: "/social/claude.webp",
    width: 80,
    height: 80,
    wrapperClass: "max-md:size-10 3xl:size-16",
  },
  {
    src: "/social/google-ai.webp",
    width: 80,
    height: 80,
    wrapperClass: "max-md:size-10 3xl:size-16",
  },
  {
    src: "/social/mircosoft-copilot.png",
    width: 80,
    height: 80,
    wrapperClass: "max-md:size-10 3xl:size-16",
  },
  {
    src: "/social/meta-black.png",
    width: 80,
    height: 80,
    wrapperClass: "max-md:size-9 3xl:size-15",
  },
  {
    src: "/social/google-ai.webp",
    width: 80,
...
const caseStudies = [
  ...
  },
  {
    ...
    description:
      "40% lower customer acquisition cost by showing up in Google's AI Overview. ",
    metrics: {
    ...
    testimonial: {
      ...
      whatsays:
        "Customers came in warmer because Google AI had already positioned us as the answer before they clicked.",
    },
    accentColor: "#FFB900",
    bgColor: "#FFE187",
  ...
  },
  {
    ...
    title: "Perplexity",
    description:
      "$320K pipeline in 60 days. Perplexity users converted faster than any other channel.",
    metrics: {
  ...
  },
  {
    ...
    title: "Claude",
    description:
      "543 qualified leads per month: how a manufacturer became Claude AI's recommended brand",
    metrics: {
    ...
    testimonial: {
      ...
      whatsays:
        "We did not know Claude was referring customers to us until they mentioned it on sales calls.",
    },
    accentColor: "#DE7356",
    bgColor: "#FFEDE8",
  ...
  },
  {
    ...
    title: "Gemini AI",
    description:
      "Grew sales 12% while cutting CPA by 27% through Gemini AI visibility",
    metrics: {
    ...
    testimonial: {
      ...
      whatsays:
        "We scaled profitably for the first time because the right people found us at the right moment.",
    },
    accentColor: "#4796E3",
    bgColor: "#EAF5FF",
    rightImage: "/seo/dashboards/dashboard-1.webp",
...
const CommunicationSectionData = [
  ...
  {
    title: "Availability",
    description: `Email directly at any time. 24-hour response guaranteed - not, "We'll get back to you within 3 business days."`,
...
const brandsLogo = [
  {
    id: 1,
    src: "/brands/brand-black/urban.webp",
    alt: "",
    customCss: "h-9 md:h-12 3xl:h-16 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/beyond.webp",
    alt: "",
    customCss: "h-9 md:h-12 3xl:h-16 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/audio-art.webp",
    alt: "",
    customCss: "h-9 md:h-12 3xl:h-16 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/mc-overalls.webp",
    alt: "",
    customCss: "h-4 md:h-6 3xl:h-7 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/cosco.webp",
    alt: "",
    customCss: "h-5 md:h-6 3xl:h-10 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/victoria-secret.webp",
    alt: "",
    customCss: "h-14 md:h-16 3xl:h-22 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/velbiom.webp",
    alt: "",
    customCss: "h-8 md:h-9 3xl:h-12 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/housr.webp",
    alt: "",
    customCss: "h-6 md:h-8 3xl:h-11 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/fab-india.webp",
    alt: "",
    customCss: "h-7 md:h-9 3xl:h-12 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/manohar-lal.webp",
    alt: "",
    customCss: "h-12 md:h-14 3xl:h-18 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/libas.webp",
    alt: "",
    customCss: "h-9 md:h-11 3xl:h-16 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/qpi-ai.webp",
    alt: "",
    customCss: "h-7 md:h-11 3xl:h-16 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/james-allen.webp",
    alt: "",
    customCss: "h-4 md:h-6 3xl:h-8 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/cyble.webp",
    alt: "",
    customCss: "h-8 md:h-12 3xl:h-14 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/tata-cliq.webp",
    alt: "",
    customCss: "h-8 md:h-10 3xl:h-12 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/tiggle.webp",
    alt: "",
    customCss: "h-7 md:h-11 3xl:h-14 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/poker-baazi.webp",
    alt: "",
    customCss: "h-8 md:h-10 3xl:h-12 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/ok.webp",
    alt: "",
    customCss: "h-9 md:h-12 3xl:h-16 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/mukunda-foods.webp",
    alt: "",
    customCss: "h-15 md:h-18 3xl:h-22 w-full",
  },
  {
    id: 1,
    src: "/brands/brand-black/biba.webp",
    alt: "",
    customCss: "h-6 md:h-7 3xl:h-10 w-full",
  },
];
...
const typeOfSeo = [{ text: "CAC" }, { text: "CMP" }, { text: "CPC" }];
...
const SeoLayout = async ({ data }) => {
  ...
  return (
    <main>
      <SeoAgencyJson faqs={data?.additionalFields.faqs} />
      ...
      <div
        className="bg-[#E7F0FF] text-black py-16 3xl:py-20 my-10 3xl:my-16 "
        id="why-upthrust"
      >
        <div className={`w-full max-sm:px-2 text-center`}>
          ...
          >
            <span className="inline lg:block">
              ...
              <span
                className={`inline-flex items-center gap-2 px-5 1800:px-6 py-1 1800:py-1.5 rounded-full capitalize bg-[#004FAC] text-white`}
              >
                <Image
                  src={"/seo/paid.webp"}
                  alt="icon"
              ...
              <span className={""}> Mentioned By</span>
            </span>

            <AnimatedWordWithImage
              textCss="  font-semibold"
              images={headingAnimateimages}
              words={headingAnimatewords}
              className="h-17 3xl:h-22 w-85 md:w-180 3xl:w-250 text-[#000000] mx-auto font-normal"
            />
          </h2>

          <p
            className={`text-[22px] px-10 3xl:text-[24px] leading-[150%] tracking-[-0.02em] font-normal`}
          >
            We optimize for Google + AI answers so customers find you in
            ChatGPT, Gemini, Claude & Perplexity too.
          </p>
        </div>
        <CircularDesign
          bgColor={"#E7F0FF"}
          mobileImage="/seo/adspent-graph-mobile.png"
          desktopImage="/seo/adspent-graph-desktop.webp"
        />
      </div>
          ...
          <div>
            <h5 className="text-4xl 3xl:text-5xl font-semibold leading-[130%] tracking-[-0.02em]">
              ...
              <AnimatedWord
                textCss="font-semibold"
                words={typeOfSeo}
                className="h-8 3xl:h-11 3xl:mb-2 w-20 3xl:w-27 text-[#FE2B27] mx-auto max-3xl:mb-1 "
              />{" "}
              Report today
            </h5>
            ...
            <div className="mt-6">
              ...
              <div className="mt-5 md:mt-6 space-y-4 md:pl-7 md:border-l-[1.5px]  ">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center gap-3 3xl:gap-5"
                  >
                    <Check
                      size={20}
                      className="size-5 3xl:size-7 bg-[#0076F0] p-1 text-white rounded-full"
                    />
                    <p className="text-xl 3xl:text-2xl leading-[150%] tracking-[-0.02em]">
                      {item}
                    </p>
                  </div>
                ))}
        ...
        <HomeFooter
          ...
          text2={{
            desktop: {
              ...
              text2:
                "OUR STRATEGY GETS YOU RANKING FASTER. MORE TRAFFIC. MORE LEADS. NO GUESSWORK.",
            },
            mobile: {
              text1:
                "OUR STRATEGY GETS YOU RANKING FASTER. MORE TRAFFIC. MORE LEADS. NO GUESSWORK.",
