...
const GoogleAdsHero = ({ title }) => {
    ...
    return (
        <div className="xl:min-h-screen bg-white max-w-[92%] mx-auto mt-15 3xl:mt-26 flex flex-col items-center w-full py-12 lg:py-20">
            {/* Center Content */}
            <div className="flex flex-col items-center text-center w-full">
                ...
                <div className="mt-10 sm:mt-10 2xl:mt-8 3xl:mt-18 flex flex-col items-center">
                    <p className="text-lg lg:text-base 3xl:text-lg tracking-[-0.02em]">Trusted By Popular Brands</p>
                    <div className="grid grid-cols-5 gap-y-3 3xl:gap-y-6 gap-x-3 md:gap-x-20 3xl:gap-x-26 items-center py-5 md:py-5 3xl:py-10 max-w-[800px] 3xl:max-w-[900px] pb-12 3xl:pb-20">
                        {brands.map((brand) => (
                            <div
                                key={brand.name}
                                className={`flex items-center justify-center gap-x-10 ${brand.width}`}
                            >
                                <Image
                                    src={brand.src}
                                    alt={"Logos of google brands partnered with Upthrust"}
