            ...
            <div className="bg-[#0076F0] text-white rounded-2xl px-8 py-4 3xl:py-10 relative overflow-hidden flex flex-col justify-between min-h-[420px]">
                ...
                <div className="flex justify-between gap-3 mt-10 ">
                    ...
                    <div className="relative mt-12">
                        ...
                        {
                            testimonial.avatar &&
                            <svg className="absolute -right-20 top-4 size-32" viewBox="0 0 95 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {testimonial.avatar && (
                        <Image
                            ...
                            className=" w-40 h-40 3xl:h-51.75 mb-10 md:w-50 3xl:w-50.25 object-contain z-10"
                        />
                    )}
