...
const GoogleFooter = ({ customeCss = "mt-20 md:mt-50" }) => {
    return (
        <div className={`relative mb-3 md:mb-5 3xl:mb-10 ${customeCss}`}>
            ...
            <div className='px-3 sm:px-5 lg:px-20 z-10 relative'>
                <div className='bg-[#0076F0] px-4 md:px-6 py-4 md:py-10 text-white text-xl md:text-3xl uppercase 3xl:text-4xl font-semibold 3xl:leading-[44px] 3xl:tracking-[-0.02em]'>
