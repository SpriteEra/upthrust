...
const services = [
    {
        ...
        title: "Performance",
        subtitle: "Creative",
        image: "/main-agency/slider-img/1.png",
    },
    {
        id: 2,
        title: "Meta",
        subtitle: "Ads",
        image: "/main-agency/slider-img/2.png",
    },
    {
        id: 3,
        title: "Google",
        subtitle: "Ads",
        image: "/main-agency/slider-img/3.png",
    },
    {
        id: 4,
        title: "UI/UX",
        subtitle: "Design",
        image: "/main-agency/slider-img/4.png",
    },
    {
        id: 5,
        title: "SEO/AEO",
        subtitle: "",
        image: "/main-agency/slider-img/5.png",
    },
    ...
    return (
        <div className="relative w-full h-full rounded-2xl overflow-hidden group cursor-pointer">
            ...
            <div className="absolute top-3.5 left-4 flex  gap-2 flex-wrap">
                ...
                <span className="text-white text-sm md:text-base lg:text-lg font-instrument xl:text-4xl 3xl:text-[44px] italic leading-[130%] font-normal tracking-[-0.02em] drop-shadow-sm">
                    {subtitle}
                </span>
            </div>
        </div>
    ...
    return (
        <div className="w-full services-slider-wrap">
            <SmartSwiper
                ...
                swiperClass="!pb-10"
                slideClass="!h-[320px] md:!h-[360px] lg:!h-[420px] 3xl:!h-[500px]"
                autoplay={true}
                delay={3000}
                speed={600}
                loop={true}
