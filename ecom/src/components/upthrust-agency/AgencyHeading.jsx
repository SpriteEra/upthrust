            ...
            <div className="mt-5 w-full">
                <Tag className={`${textAlign}`}>
                    {heading.map((row, rowIndex) => {
                        ...
                        const italicClass =
                            "capitalize text-4xl  md:text-4xl lg:text-[65px] xl:text-7xl 3xl:text-[5rem] font-instrument italic leading-11 md:leading-[120%] tracking-[-0.02em] xl:tracking-[-0.04em] font-normal ";
