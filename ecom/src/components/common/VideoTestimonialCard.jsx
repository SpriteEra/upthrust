            ...
            <div className={`${testimonial.bgColor} text-white rounded-2xl px-4 sm:px-6 py-4 3xl:py-10 relative overflow-hidden flex flex-col justify-between min-h-90 xl:min-h-100 2xl:min-h-[420px] 3xl:min-h-140`}>
                <h3 className="text-3xl 3xl:text-4xl leading-[130%] tracking-[-0.02em] font-semibold max-w-sm 3xl:max-w-md relative">
                    {testimonial.title}
                    {
                        ...
                        <svg className={testimonial.highlightCss} viewBox="0 0 159 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 7.86795C1.20455 4.6237 3.82242 4.12582 6.26364 3.91704C14.84 3.27461 23.32 1.39552 31.9285 1.74885C42.8336 2.26279 53.7227 1.01007 64.5797 0.688853C83.8524 0.094611 103.013 -0.274783 122.318 0.255217C133.672 0.576429 145.075 2.02188 156.495 1.02613C157.635 0.913702 158.759 1.57219 158.727 2.47158C158.727 4.0134 157.506 4.19007 156.061 4.06158C131.006 2.29491 105.952 2.88916 80.8491 2.32704C66.9727 2.00582 53.0803 3.51552 39.1718 4.17401C31.5912 4.55946 23.9785 4.0134 16.3658 5.08946C10.9855 6.02097 5.49273 6.02098 0 7.86795Z" fill="white" />
                        </svg>
                ...
                <div className="flex justify-between gap-3 mt-10 items-center w-full ">
                    <div className="relative">
                        ...
                        {
                            testimonial.avatar &&
                            <svg className={`${testimonial?.arrowcss} `} viewBox="0 0 95 35" fill="none" xmlns="http://www.w3.org/2000/svg">
