...
const badges = [
    ...
    { image: "/badges/highest-user-adoption.webp", alt: "Highest User Adoption Badge", },
]
const ReadyToMoveUiUx = () => {
    return (
        <div className="bg-black p-4 md:pt-14 lg:pt-24 lg:pb-24 md:px-6 lg:px-6 mt-36 3xl:mt-42">
            <div className="max-w-6xl 3xl:max-w-7xl mx-auto">
                {/* CTA CARD */}
                <div className="bg-white rounded-xl md:rounded-2xl lg:rounded-3xl 3xl:rounded-4xl p-4 md:px-20 3xl:px-30 md:py-8 lg:py-12 3xl:py-14 text-center relative overflow-hidden mb-10 md:mb-20">
                    <div className='max-w-4xl 3xl:max-w-5xl mx-auto'>
                        ...
                        <div className="flex items-center md:justify-between flex-wrap gap-2 max-md:justify-center">
                            {
                                ["30 Minutes", "Clear Direction", "No Obligation"].map((item, index) => (
                                    <div className="flex items-center gap-2" key={index}>
                                        <span className="w-5 h-5 flex items-center justify-center rounded-full bg-[#f45d48] text-white text-xs">
                                            <Check className='size-4' strokeWidth={3} />
                                        </span>
                                        <span className="text-black font-semibold text-base sm:text-xl 3xl:text-2xl">{item}</span>
                                    </div>
                                ))
                            }
                        </div>
                ...
                {/* BADGES ROW */}
                <div className="flex flex-wrap gap-5 sm:gap-6 md:gap-10 w-full items-center justify-center">
                    {
