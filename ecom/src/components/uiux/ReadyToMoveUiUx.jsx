        ...
        <div className="bg-black p-4 md:pt-14 lg:pt-24 lg:pb-24 md:px-6 lg:px-6 mt-36 3xl:mt-42">
            <div className="max-w-6xl 3xl:max-w-7xl mx-auto">
                ...
                <CutCornerBackground
                    ...
                    cutRadius={0.5}
                >
                    <div className="rounded-xl md:rounded-2xl lg:rounded-3xl 3xl:rounded-4xl p-4 md:px-20 3xl:px-30 md:py-8 lg:py-12 3xl:py-14 text-center relative overflow-hidden mb-10 md:mb-20">
