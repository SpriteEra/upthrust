...
export const Disclaimer = () => {
    ...
    return (
        <div className="mt-16 lg:mt-12 3xl:mt-14 border-t border-gray-300 pt-2 md:pt-3">
            ...
            {/* CONTENT */}
            <div
                className={`overflow-hidden transition-all duration-500 ease-in-out ${open ? "max-h-500 opacity-100 mt-2" : "max-h-0 opacity-0"
                    }`}
            >
            ...
            <div className='flex justify-between max-xs:flex-col-reverse gap-14  md:gap-20'>
                ...
                <div className='flex flex-col md:justify-between md:items-center gap-6 md:gap-8 max-md:pl-2'>
                    ...
                    <div className='flex gap-3 items-start'>
                        ...
                        <p className='text-sm md:text-xs 3xl:text-base max-w-70 md:max-w-100 3xl:max-w-80 xs:max-w-70 leading-[140%]'>Paid ads, scroll-stopping creatives, and
                            profitable campaigns.</p>
                    </div>
                </div>
            </div>
            <Disclaimer />
