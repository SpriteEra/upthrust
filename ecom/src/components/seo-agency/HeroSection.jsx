...
const brands = [
  {
    name: "brand1",
    src: "/brands/brand-black/harley-davidson.webp",
    alt: "",
    width: "h-7 xs:h-8 lg:h-12 w-13 sm:w-17 xl:w-17 3xl:h-15 3xl:w-30",
  },
  {
    name: "brand2",
    src: "/brands/brand-black/loreal.webp",
    alt: "",
    width: "h-7 xs:h-8 lg:h-13 w-13 sm:w-17 xl:w-25 3xl:h-16 3xl:w-40",
  },
  {
    name: "brand3",
    src: "/brands/brand-black/zomato.webp",
    alt: "",
    width: "h-8 xs:h-6 lg:h-13 w-15 sm:w-17 xl:w-20 3xl:h-15 3xl:w-40",
  },
  {
    name: "brand4",
    src: "/brands/brand-black/dell.webp",
    alt: "",
    width: "h-7 xs:h-8 lg:h-12 w-12 sm:w-17 xl:w-15 3xl:h-15 3xl:w-27",
  },
  {
    name: "brand5",
    src: "/brands/brand-black/vwo.webp",
    alt: "",
    width: "h-7 xs:h-8 lg:h-12 w-12 sm:w-17 xl:w-16 3xl:h-15 3xl:w-28",
  },
  {
    name: "brand7",
    src: "/brands/brand-black/qpi-ai.webp",
    alt: "",
    width: "h-6 xs:h-8 lg:h-9 w-14 sm:w-17 xl:w-20 3xl:h-12 3xl:w-30",
  },
  {
    name: "brand6",
    src: "/brands/brand-black/poker-baazi.webp",
    alt: "",
    width: "h-7 xs:h-8 lg:h-12 w-12 sm:w-20 xl:w-24 3xl:h-15 3xl:w-40",
  },
  {
    name: "brand8",
    src: "/brands/brand-black/bosch.webp",
    alt: "",
    width: "h-8 xs:h-8 lg:h-12 w-15 sm:w-17 xl:w-20 3xl:h-15 3xl:w-40",
  },
  {
    name: "brand9",
    src: "/brands/brand-black/cyble.webp",
    alt: "",
    width: "h-8 xs:h-8 lg:h-12 w-13 sm:w-17 xl:w-20 3xl:h-15 3xl:w-40",
  },
  {
    name: "brand10",
    src: "/brands/brand-black/welspun.webp",
    alt: "",
    width: "h-6 xs:h-8 lg:h-12 w-12 sm:w-17 xl:w-20 3xl:h-15 3xl:w-40",
  },
];
...
const SeoAgencyHero = ({ title, formUrl }) => {
  ...
  return (
    <div className="xl:min-h-screen bg-white max-w-[92%] mx-auto mt-15 3xl:mt-26 flex flex-col items-center w-full py-12 lg:py-20 text-center">
      {/* Rating Icons */}
      <div className="relative flex items-center justify-center mb-2 3xl:mb-3">
        <Image
          src="/google-ads/clutch.webp"
          alt="Clutch Logo"
          width={100}
        ...
        <Image
          ...
          width={100}
          height={100}
          className="object-contain size-10 -ml-3"
        />
      </div>

      {/* Stars */}
      <div className="flex items-center justify-center gap-2 mb-3 md:mb-4 3xl:mb-5">
        <span className="text-sm 2xl:text-[16px] 3xl:text-[17px]">4.9</span>
        <div className="flex gap-1">
          <RatingStars
            rating={5}
            fillColor="#FFB900"
            size="size-4.75 3xl:size-5"
          />
        </div>
      </div>

      {/* Subtitle with animated word */}
      <p className="text-lg 3xl:text-xl text-black mb-3 xl:mb-4 font-normal leading-[150%] tracking-[-0.02em] flex items-center justify-center gap-1 flex-wrap">
        {title}
        <AnimatedWord
          words={words2}
      ...
      {/* Main Heading */}
      <h1 className="text-[42px] lg:text-5xl 2xl:text-6xl 1600:text-[78px] 1800:text-[86px] tracking-[-0.04em] font-semibold leading-[120%] mb-1 xl:mb-2">
        Get Found Everywhere <br />
        Your <span className="text-[#FE2B27]">Customers</span>
        <br />
      ...
      {/* Description */}
      <p className="text-lg 3xl:text-xl text-black mb-8 3xl:mb-10 font-normal leading-[150%] tracking-[-0.02em]">
        Most agencies chase rankings. We chase revenue.{" "}
        <br className="max-md:hidden" />
        Our 'Triple Algorithm' method delivers 3X more conversions in 120 days.
      </p>
      ...
      <div className="mt-10 sm:mt-10 2xl:mt-8 3xl:mt-18 flex flex-col items-center w-full">
        <p className="text-lg lg:text-base 3xl:text-lg tracking-[-0.02em]">
          Trusted By Popular Brands
        </p>
        <div className="flex flex-col gap-y-2 3xl:gap-y-6 py-5 md:py-5 3xl:py-10 w-full max-w-xl 1600:max-w-4xl 1800:max-w-[950px] pb-12 3xl:pb-20">
          {/* First row (5 items) */}
          <div className="flex justify-between gap-x-2 3xl:gap-x-5 max-h-[54px]">
            {brands?.slice(0, 5).map((brand) => (
              <div
              ...
              >
                <Image
                  src={brand.src}
                  alt="Logos of brands partnered with Upthrust"
                  width={250}
                  height={60}
                  className="max-h-full max-w-full object-contain select-none"
                />
