...
const MetaFooter = ({ customeCss = "mt-20 md:mt-50" }) => {
    return (
        <div className={`relative mb-3 md:mb-5 3xl:mb-10 ${customeCss}`}>
            <div className="w-full overflow-hidden -mb-9 md:-mb-2 3xl:-mb-22 z-1">
                <marquee
                    behavior="scroll"
                    direction="left"
                    scrollamount="16"
            ...
            <div className='px-3 px-5 lg:px-20 z-10 relative'>
                <div className='bg-(--red) px-4 md:px-6 py-4 md:py-10 text-white text-xl md:text-3xl uppercase 3xl:text-4xl font-semibold 3xl:leading-[44px] 3xl:tracking-[-0.02em]'>
                    <div className="flex items-center gap-2 flex-wrap">
                        <button className="inline-flex items-center gap-1 sm:gap-2 border-[0.5px] lg:border border-white rounded-full px-1.25 md:px-3 py-0.75 md:py-1.5 uppercase text-[8px] md:text-xs 3xl:text-xs">
                    ...
                    <div className='max-md:hidden whitespace-pre-line'>
                        {`OUR EXCITED RESPONSE COMES SHORTLY AFTER.
