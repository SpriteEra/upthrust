export const cards = [
  {
    id: 1,
    img: "/performance-agency/SliderImg (5).png",
    category: "PREMIUM FOOTWEAR",
    title: "Atlanta Mocassin",
    price: "₹1.8L → ₹5.05L/mo",

    text: `"You've hit your ceiling". We proved them wrong.`,
    ...
    quote:
      "Previous Agency Said 'You've Hit Your Ceiling.' Upthrust Proved Them Wrong In 4 Months.",
  ...
  {
    id: 3,
    img: "/performance-agency/SliderImg (3).png",
    category: "BEVERAGE",
