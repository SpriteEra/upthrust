...
const MobileTestimonialsSlider = ({ testimonials }) => {
    ...
    return (
        <div className="lg:hidden px-4 py-20 pb-10 min-h-50 bg-black mt-24">
            <div className="flex flex-col items-center justify-center mb-10">

                <p className="text-3xl font-medium text-white leading-tight text-center">
                    The <span className="italic font-instrument">Secret</span> Behind
                </p>
                <p className="text-3xl font-medium text-white leading-tight text-center">
                    Their <span className="italic font-instrument ">Success</span>
                </p>
            </div>
            <Swiper
                modules={[Autoplay]}
            ...
            >
                ...
                {testimonials.map((testimonial, index) => (
                    <SwiperSlide key={index} className="">
                        <div className={`${testimonial.color} p-5 max-xs:py-8 rounded-md w-full max-w-100 xs:w-70 h-106 xs:h-82 flex flex-col justify-between mx-auto`}>
                            <p className="text-black text-[22px] xs:text-lg 3xl:text-2xl font-medium">
                                <span className='-pt-3'>
                            ...
                            <div className="flex items-center gap-3 mt-10 xs:mt-3">
                                ...
                                <div>
                                    <p className="text-xl 3xl:text-[22px] text-[#010202]">{testimonial.name}</p>
