...
//                                     <div className='hidden sm:flex absolute top-0 left-0 right-0 bottom-0 z-20 text-white p-3 md:p-5 justify-between flex-col w-3/5 xs:max-w-1/2 3xl:max-w-100'>
//                                         <div>
...
//                                     {/* ── MOBILE: centered circular play button ── */}
//                                     <button
//                                         onClick={() => setPlayingId(item.id)}
//                                         className="sm:hidden absolute inset-0 z-20 flex items-center justify-center cursor-pointer"
...
//                                             >
//                                                 <path d="M7 4.5L20 12L7 19.5V4.5Z" fill="#1a1a1a" />
//                                             </svg>
//                                         </div>
//                                     </button>

//                                     {/* Desktop clickable overlay (hidden on mobile) */}
//                                     <button
//                                         onClick={() => setPlayingId(item.id)}
//                                         className="hidden sm:block absolute inset-0 z-20 cursor-pointer"
//                                         aria-label="Play video"
//                                     />
