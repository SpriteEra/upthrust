                ...
                {features.map((feature, index) => (
                    <React.Fragment key={index}>
                        ...
                        <div className="py-3 xs:py-5 md:py-10 3xl:py-7 max-lg:px-3 lg:pr-12 text-right flex items-center lg:min-w-sm">
                            <p className="align-middle max-w-sm md:text-start text-center">
                                <span
                                    className="font-semibold text-sm lg:text-base 3xl:text-xl text-center"
                                >
                                    {feature.title}
                                </span>

                                <span
                                    className="ml-1 font-instrument italic text-sm lg:text-base 3xl:text-xl"
                                >
                                    {feature.sub}
                                </span>
                            </p>
                        ...
                        {/* Brand Check Column */}
                        <div className={`flex justify-center items-center py-3 xs:py-5 md:py-10 3xl:py-7 bg-[#F4F4F4] border-b-2 border-white`}>
                            <div className="p-1.5 xs:p-2 md:p-3 rounded-full bg-white flex items-center justify-center">
                                <div className="p-0.5 xs:p-1 rounded-full bg-(--red) flex items-center justify-center ">
                        ...
                        <div className="flex justify-center items-center py-3 xs:py-5 md:py-10 3xl:py-7 bg-[#F9F9F9] border-b-2 border-white">
                            <X className="text-[#9FA4B3] size-5 xs:size-9 md:size-10 font-thin" strokeWidth={2} />
                        </div>

                        {/* In-House Column */}
                        <div className={`flex justify-center items-center py-3 xs:py-5 md:py-10 3xl:py-7 bg-[#F9F9F9] border-b-2 border-white ${index === features.length - 1 ? 'lg:rounded-br-4xl 3xl:rounded-br-[35px]' : ''
