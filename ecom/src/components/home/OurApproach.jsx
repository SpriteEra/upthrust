...
//             // Only drive while section is pinned in view
//             if (rect.top <= 0 && rect.bottom >= windowHeight) {
//                 const scrollProgress =
//                     Math.abs(rect.top) / (section.offsetHeight - windowHeight);

//                 // 0→3 step index as user scrolls through the section
//                 const stepIndex = Math.min(
//                     steps.length - 1,
//                     Math.floor(scrollProgress * steps.length)
//                 );

//                 // Rotate exactly like the auto version: each step = +STEP_ANGLE
//                 const nextAngle = stepIndex * STEP_ANGLE;

//                 if (angleRef.current !== nextAngle) {
//                     angleRef.current = nextAngle;

//                     // Mirror the exact same activeIndex calculation from the original
