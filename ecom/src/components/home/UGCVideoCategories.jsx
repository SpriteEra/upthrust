...
const navLinks = [
...

  {
    ...
    items: [
      ...
      { id: 9, image: "/ecom/ugcs/lifestyle/lifestyle9.webp", videoUrl: "https://cdn.upthrust.agency/Ecom%20page%20assets/Lifestyle/seetramp4.mp4" },
      { id: 10, image: "/ecom/ugcs/lifestyle/lifestyle10.webp", videoUrl: "https://cdn.upthrust.agency/Ecom%20page%20assets/Lifestyle/soundart.mp4" },
       { id: 11, image: "/ecom/ugcs/beauty/beauty3.webp", videoUrl: "https://cdn.upthrust.agency/Ecom%20page%20assets/UGC's/Beauty%20%26%20Skincare/KIWIBYMUSSKANmp4.mp4" },
    ]
  },
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute -top-3 -right-3 z-20 size-9 rounded-full bg-white text-black flex items-center justify-center shadow-lg hover:bg-gray-100 transition-colors duration-150"
...
const UGCVideoCategories = () => {
  ...
  return (
    <div>
      {/* VIDEO MODAL */}
      {modalVideoUrl && (
        <VideoModal videoUrl={modalVideoUrl} onClose={handleCloseModal} />
      )}
            ...
            {activeCategory.items.map((item, index) => {
              return (
                <motion.div
                  ...
                  className={`relative w-[220px] h-[380px] 3xl:w-85 3xl:h-150 bg-white p-2 3xl:p-4 pb-4 3xl:pb-7 cursor-pointer
                  ${rotations[index % rotations.length]} transition-all duration-300 hover:z-50 hover:rotate-0! hover:scale-105`}
                  style={{ boxShadow: "rgba(149, 157, 165, 0.2) 0px 8px 24px" }}
                >
                  {/* Image */}
                  <Image
