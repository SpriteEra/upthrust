...
const brandicons = [
    ...
    { src: '/brands/brand-black/dell.webp', alt: 'Dell', customCss: "w-16 sm:w-22 md:w-24 lg:w-26 xl:w-18 2xl:w-19 3xl:w-22 h-fit" },
    { src: '/brands/brand-black/harley-davidson.webp', alt: 'harley-davidson', customCss: "w-15 sm:w-16 xl:w-16 2xl:w-17 3xl:w-18 h-fit" },
    { src: '/brands/brand-black/cosco.webp', alt: 'cosco', customCss: "w-16 sm:w-22 md:w-24 lg:w-26 xl:w-19 2xl:w-19 3xl:w-22 h-fit" },
]
            ...
            <div className="w-full justify-center items-center flex flex-col lg:flex-row gap-4">
                ...
                <div className="space-y-5 max-sm:h-[100vh - 80px] w-full lg:max-w-[48%] text-black relative">
                    ...
                    <div className="flex max-sm:text-left justify-center sm:justify-start gap-2 items-start sm:items-center">
                        <p className="text-lg xl:text-base 3xl:text-[20px] leading-[150%] tracking-[-0.02em] font-normal">Performance creative for brands ready to scale:</p>
                    </div>
                    ...
                    <h1 className="text-[42px] lg:text-[50px] 2xl:text-[55px] 3xl:text-[65px] 1800:text-[72px] leading-[120%] sm:leading-[130%] tracking-[-0.04em] font-semibold max-sm:text-left capitalize">
                        ...
                        <span className="text-orange"> CPAs.</span><br />
                        Keep your brand.
                        <br />
                        Scale every month.
                    </h1>
                    ...
                    <p className="text-lg 3xl:text-[20px] leading-[150%] tracking-[-0.02em] mt-10 font-normal">
                        Stop burning budget on ads that fatigue in a week. Start shipping 10–15 tested variants every month that convert.
                    </p>
                    {/* CTA Button */}
