...
const dashboardData = [
    ...
    },
    {
        ...
        description: "We helped EzSleep break through a saturated wellness market where most pillow brands compete on price alone. By leading with pain-point video highlighting real problems like neck pain and poor sleep and pairing it with a full-funnel Meta Ads strategy combining educational awareness content, benefit-focused retargeting, testimonial-led conversion ads, and scaling of winning audiences we built a predictable growth system. The result was a measurable lift in purchases, healthier ROAS, and strong repeat buyer rates.",
        link: "#",
    ...
    },
    {
        ...
        description: "We helped Tiggle carve out a unique position in the crowded beverage market by leading with a guilt-free angle that turned calorie-conscious consumers into loyal buyers. By creating comparison-driven videos making the 150-kcal message instantly memorable and running a full-funnel Meta Ads strategy combining health-conscious prospecting, variant-specific retargeting, social proof campaigns, and systematic scaling we built a repeatable purchase engine. The result was steady order growth, efficient CPAs, and strong AOV.",
        link: "#",
