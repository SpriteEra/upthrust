...
export default function ClientStories() {
    ...
    const testimonials = [
        ...
        },
        {
            id: 2,
            rating: 5,
            title: " “My business was in turmoil. One last chance to make it work. Made a $4,900 bet with Upthrust got 2.7x back immediately. Now doing $51K+ monthly. Beyond my wildest dreams.” ",
            author: "Dan",
            position: "Dan Studios",
            hasAvatar: true,
            avatar: "/video-production/dan.png",
            avatarShape: {
                rounded: "full",
                width: "w-16 3xl:w-25",
...

        {
            id: 4,
            rating: 5,
            title: "How Upthrust Strengthened M.C.Overalls Marketing",
            author: "Troy, CEO",
            position: "Built on strong strategic fundamentals",
            company: "/video-production/mcoveralls.png",
            hasVideo: true,
            hasAvatar: true,
            avatar: "/video-production/troy.png",
            hasVideo: true,
