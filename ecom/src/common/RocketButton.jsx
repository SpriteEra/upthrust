...
const StylishButton = ({ color = "red" }) => {
    ...
    return (
        ...
        <button className="px-6 h-[50px] 2xl:h-[65px] 3xl:h-[70px] rounded-full py-2 bg-black border-2 border-(--red) hover:border-white hover:bg-(--red) text-white text-sm transition-colors duration-200 flex items-center space-x-2 relative group">
            <span>Show Us</span>
