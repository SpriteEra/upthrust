...
const PerfromanceHeading = ({
    ...
    return (
        <div className={`flex flex-col max-sm:px-2 ${containerAlign}`}>
            ...
            <div className="mt-5 w-full">
                <Tag className={`${textAlign} tracking-[-0.02em] xl:tracking-[-0.04em] ${textcss}`}>
                    {heading.map((row, rowIndex) => {
                        ...
                        const italicClass =
                            "text-[2.625rem] md:text-[3.125rem] lg:text-[3.4375rem] xl:text-[4.375rem] 1600:text-[4.5rem] 1800:text-[5rem] font-normal text-center leading-11 xl:leading-[120%] tracking-[-0.02em] xl:tracking-[0em] capitalize font-instrument italic";
            ...
            {subtitle && (
                <span
                    className={`text-lg lg:text-sm 3xl:text-lg mb-10 mt-1 text-center leading-[150%] tracking-[-0.02em] ${textAlign} ${subTitleCss}`}
                >
                    {subtitle}
                </span>
            )}
...
export default PerfromanceHeading;
