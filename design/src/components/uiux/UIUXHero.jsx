...
const DEFAULT_HERO = {
    ...
    line3: "FRIENDS",
    feature1: "Built from real-world product experience",
    feature2: "Shaped by years of building and scaling B2B products",
};

export default function UIUXHero({ title, hero }) {
    const [currentWord, setCurrentWord] = useState(0);
    const words = ['PRODUCTS', 'WEBSITES', 'APPS', 'BRANDS'];
    ...
    // Merge passed hero data with defaults so ui-ux page keeps working unchanged
                    ...
                    <div className="relative rounded-[40px] overflow-hidden pt-2 2xl:pt-8 3xl:pt-10 lg:pb-2 3xl:pb-10 px-3 sm:px-8 md:px-12 lg:px-8 3xl:px-12">
                        ...
                        <div className="flex flex-col sm:flex-wrap sm: lg:flex-row items-center sm:max-w-[330px] lg:max-w-none  sm:mx-auto sm:items-start lg:items-center sm:justify-start lg:justify-between gap-4 sm:gap-5 lg:gap-10 max-md:px-6 mb-4 lg:mb-8 3xl:mb-5 lg:border-t border-gray-400 lg:pt-8 3xl:pt-10">
                            ...
                            <div className="flex items-center gap-4 3xl:gap-6 flex-1 w-full sm:w-auto">
                                ...
                                <div>
                                    <p className=" text-[14px] lg:text-[16px] 3xl:text-2xl md:tracking-[-0.02em]">
                                        {h.feature1}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 3xl:gap-6 flex-1 w-full sm:w-auto max-md:hidden">
                                ...
                                <div>
                                    <p className=" text-[15px] lg:text-[16px] 3xl:text-2xl tracking-[-0.02em]">
                                        {h.feature2}
                                    </p>
                                </div>
                            </div>
