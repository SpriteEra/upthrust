    ...
    return (
        <div className="bg-black p-4 md:pt-14 lg:pt-24 lg:pb-24 md:px-6 lg:px-6 mt-36 3xl:mt-42 relative overflow-hidden">
            ...
            <Curve1
                ...
                imageClassName="left-12 top-20 3xl:top-28 3xl:size-20!"
                curvePosition="end"
                ...
                tiltAngle={5}
                imageIndex={7}
                className="absolute top-1/4 !text-white right-10 xl:right-10 3xl:right-24  max-w-[300px] 3xl:max-w-[350px]"
            />
            ...
            <div className="max-w-5xl 3xl:max-w-[1250px] mx-auto">
                ...
                <CutCornerBackground
                    ...
                    cutRadius={1}
                >
                    <div className="rounded-xl md:rounded-2xl lg:rounded-3xl 3xl:rounded-4xl p-4 md:px-20 3xl:px-30 md:py-8 lg:py-8 2xl:py-12 3xl:py-14 text-center relative overflow-hidden">
                                ...
                                {["30 Minutes", "Clear Direction", "No Obligation"].map(
                                    (item, index) => (
                                        <div className="flex items-center gap-1 lg:gap-2" key={index}>
                                            ...
                                            <span className="text-black lg:font-semibold text-xl sm:text-xl 3xl:text-2xl">
                                                {item}
                                            </span>
                                        </div>
                                    ),
