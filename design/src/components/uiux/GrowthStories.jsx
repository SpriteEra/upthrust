...
//                     >
//                         <div className={`${item.bgColor2} lg:bg-none! p-4 sm:p-6 max-2xl:pr-1 3xl:p-12.5 lg:w-[55%] 3xl:w-[40%] h-full flex flex-col lg:rounded-l-3xl 3xl:rounded-l-4xl`}>
...
// ── Default stories (ui-ux page) ────────────────────────────────────────────
const defaultGrowthStories = [
    {
        name: "PRODUCT DESIGN",
        title: "From ZERO brand awareness to 260% boost in lead gen. ",
        rating: 4.5,
