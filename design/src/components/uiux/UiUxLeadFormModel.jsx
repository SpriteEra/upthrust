...
const brands = [
    { name: "brand1", src: "/brand/brandwhite/brand1.webp" },
    { name: "brand2", src: "/brand/brandwhite/brand2.webp" },
    { name: "brand3", src: "/brand/brandwhite/brand11.webp" },
    { name: "brand4", src: "/brand/brandwhite/brand4.webp" },
    { name: "brand5", src: "/brand/brandwhite/brand6.webp" },
    { name: "brand6", src: "/brand/brandwhite/brand7.webp" },
    { name: "brand7", src: "/brand/brandwhite/brand8.webp" },
    { name: "brand8", src: "/brand/brandwhite/brand9.webp" },
];
const TestimonialSection = () => (
    <div className="h-full flex flex-col overflow-hidden">

        {/* TOP IMAGE SECTION */}
        <div className="relative h-[65%]  2xl:h-[65%]">
        ...
        {/* BOTTOM ORANGE SECTION */}
        <div className="bg-orange-600 p-4 xl:p-6 px-6 xl:px-8 h-[35%] 2xl:h-[35%] flex flex-col justify-evenly">
            <p className="text-white text-sm font-medium mb-4">
                Trusted by Shark tank and 48 other brands
            </p>

            <div className="grid grid-cols-4 gap-y-4 2xl:gap-y-6 gap-x-2 xl:gap-y-3 3xl:gap-x-8 items-center py-5 md:py-5 max-w-xl">
                {brands.map((brand) => (
                    <div
                        key={brand.name}
...
// Main Form Component
const UiUxLeadFormModel = ({ handleClose }) => {
...
export default UiUxLeadFormModel;