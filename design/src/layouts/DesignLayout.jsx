...
//                             },
//                         ]}
//                         imageClassName="left-0 3xl:left-8 -top-16 3xl:-top-20 size-14! 3xl:size-20!"
//                         curvePosition="end"
//                         imageIndex={3}
//                         curveFlipHorizontal={true}
//                         curveFlipVertical={false}
//                         tiltAngle={5}
//                         hiddenInSmall={false}
//                         className="absolute -bottom-46 lg:-bottom-15 xl:-bottom-40 3xl:-bottom-40 right-16 lg:-right-5 xl:right-44 3xl:right-55 max-w-[300px] 3xl:max-w-[350px]"
//                     />
//                 </div>
//             </div>
...
//                         },
//                     ]}
//                     imageClassName="right-8 top-18 3xl:top-24 3xl:w-9"
//                     curvePosition="end"
//                     curveFlipHorizontal={true}
//                     curveFlipVertical={false}
//                     tiltAngle={5}
...
//                                             </p>
//                                         </div>
//                                         <div className="col-span-2 tracking-[-0.02em]">
//                                             <p className="text-base lg:text-sm 2xl:text-base 3xl:text-lg uppercase">
//                                                 {item.valueText1}
//                                             </p>
//                                             <p className="text-base lg:text-sm 2xl:text-base 3xl:text-lg uppercase">
//                                                 {item.valueText2}
...
//                         ))}
//                     </div>
//                     <div className="mt-16 lg:mt-10 rounded-3xl 3xl:rounded-4xl bg-black p-6 sm:p-8 flex justify-between flex-wrap gap-8 lg:gap-5">
...
//                         },
//                     ]}
//                     imageClassName="left-16 3xl:left-20 top-20 3xl:top-24 scale-x-[-1] rotate-[20deg] 3xl:w-9"
//                     curvePosition="end"
//                     curveFlipHorizontal={true}
//                     curveFlipVertical={false}
//                     tiltAngle={5}
...
//                     heading={[
//                         {
//                             line: [{ type: "normal", text: "What We Help You" }, { type: "italic", text: "Design" }],
//                         },
...
//                         },
//                     ]}
//                     imageClassName="right-8 top-24 3xl:top-28 size-14! 3xl:size-20! scale-y-[-1] scale-x-[-1] rotate-[30deg]"
//                     curvePosition="end"
...
//                         <div>
//                             <span className="border border-black/30 px-2 3xl:px-6.5 py-1 3xl:py-4 rounded-full uppercase text-sm 3xl:text-lg w-fit leading-[-0.02em]">
//                                 Our process
//                             </span>
//                         </div>
...
//                                 <div>
//                                     {/* Badge */}
//                                     <span className="inline-flex items-center gap-2 text-lg lg:text-base 3xl:text-lg tracking-[-0.02em] py-1 px-4 lg:px-3 lg:py-1 3xl:py-2.5 3xl:px-4 rounded-full border border-[#FF03034D] text-(--red) mb-8 3xl:mb-10">
//                                         <svg
...
//                                 ].map((item, index) => (
//                                     <div
//                                         className="flex items-center gap-2 sm:gap-2 3xl:gap-2"
//                                         key={index}
//                                     >
...
//                         },
//                     ]}
//                     imageClassName="left-20 2xl:left-12 top-20 3xl:top-26 scale-x-[-1] rotate-[20deg] size-16!"
//                     curvePosition="end"
//                     curveFlipHorizontal={true}
//                     curveFlipVertical={false}
//                     tiltAngle={5}
...
//                 />
//                 <div className="max-sm:w-full sm:max-w-[90%] 3xl:max-w-[88%] sm:mx-auto max-sm:px-2 mt-10 lg:mt-20 3xl:mt-24">
//                     <WorkingWithUs />
//                 </div>
//             </div>
...
//                 />
//                 <div className="sm:max-w-[90%] 3xl:max-w-[88%] max-sm:px-2 sm:mx-auto w-full mt-0 3xl:mt-16">

//                     <FinalProducts />

//                     <div className="mt-10 rounded-2xl 3xl:rounded-4xl bg-black p-6 sm:p-8 flex justify-between flex-wrap gap-6">
...
//                             },
//                         ]}
//                         imageClassName="right-4 3xl:right-12 top-20 3xl:top-26 scale-y-[-1] scale-x-[-1] size-14! 3xl:size-20!"
//                         curvePosition="end"
//                         curveFlipHorizontal={true}
//                         curveFlipVertical={false}
//                         tiltAngle={-10}
...
const DEFAULT_STATS_ARROW_NOTE = {
    line1Parts: [
        { type: "text", text: "The" },
...
const DEFAULT_TRAFFIC_TO_LEADS = {
    arrowNote: {
        line1Parts: [
            { type: "text", text: "If" },
            { type: "highlight", text: "users", bgColor: "#FF4500" },
            { type: "text", text: "hesitate," },
        ],
    ...
    label: "Growth stalls for predictable reasons",
    subtitle: "Most products don't fail because of traffic; they fail because users get confused, stuck, or unconvinced. We fix that.",
    cards: [
        {
            buttonText: "Low conversions?",
            title: "Users sign up… then disappear?",
    ...
    ctaBar: "Let's design an experience that converts.",
};
...
const DEFAULT_PROCESS = {
    ...
    label: "Our approach",
    subtitle: "Clear steps. No confusion. Focused on results.",
    processBlurb: "Growth doesn't come from random improvements. It comes from understanding what's broken, what matters most, and fixing it in the right order, across product, brand, and performance.",
    preCommitCard: {
        badge: "LIMITED AVAILABILITY",
        headingDesktop: "See What Working With Us Looks Like; \nBefore Committing",
        headingMobile: "See What Working With Us Looks Like; Before Committing",
        checklistMobile: [
            "Strategy alignment session",
            "High-impact design output",
            "UI/UX recommendations",
...
const DEFAULT_PORTFOLIO = {
    ...
    label: "Designed. Delivered. Visualized.",
    subtitle: "A visual overview of the brands and products we've designed.",
    ctaBar: "Let's create an experience your product deserves.",
    clutch: {
        score: "4.6 Avg Score",
        reviewCount: "Based on 80+ reviews",
    },
    testimonialsBlurb: "Founders and leaders share how our design process, clarity, and execution helped them move forward with confidence.",
};

const DEFAULT_FAQ_ARROW_NOTE = {
    line1Parts: [{ type: "text", text: "This usually come up" }],
    line2Parts: [
        { type: "text", text: "before" },
...
// ─── Helper: render ArrowNote lines from data ───────────────────────────────
const renderArrowNoteLines = (arrowNote) => [
    { parts: arrowNote.line1Parts },
    { parts: arrowNote.line2Parts },
];
...
const DesignLayout = ({ data }) => {
    ...
    const statsArrow = data.statsArrowNote ?? DEFAULT_STATS_ARROW_NOTE;
    const traffic = data.trafficToLeads ?? DEFAULT_TRAFFIC_TO_LEADS;
    const services = data.servicesSection ?? DEFAULT_SERVICES;
    const process = data.processSection ?? DEFAULT_PROCESS;
    const workingWithUs = data.workingWithUs ?? DEFAULT_WORKING_WITH_US;
    ...
    return (
        <main>
            <UiUxNavbar />
            <div className=" bg-black">
                <UIUXHero title={data.title} hero={data.hero} />
                <AnimatedLogoCarousel />
            </div>
            ...
            <div className="flex flex-col  mt-60 lg:mt-26 3xl:mt-40 relative scroll-mt-30 3xl:scroll-mt-35" id='case-studies'>
                <ArrowNote
                    lines={renderArrowNoteLines(caseStudies.arrowNote)}
                    imageClassName="right-1/2 sm:translate-x-1/2 lg:translate-x-0  max-lg:rotate-65 lg:right-8 top-14 3xl:top-16"
                    curvePosition="end"
                    curveFlipHorizontal={true}
                    curveFlipVertical={false}
                ...
                <GrowthStories growthStories={caseStudies.growthStories} />

                {/* ── STATS STRIP ─────────────────────────────────────────── */}
                <div className="max-w-[90%] mx-auto w-full grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-4 md:gap-5 3xl:gap-10 mt-20 lg:mt-10 3xl:mt-26 relative max-lg:mb-60">
                    {stats.map((item, index) => (
                        <CutCornerBackground cutConfig={{ mobile: { cutWidth: 14, cutHeight: 22, cutRadius: 2 } }} bgColor="#F9F9F9" key={index}>
                            <div className="shape-wrap p-4 lg:p-8 3xl:p-12.5 flex flex-col rounded-2xl lg:rounded-3xl 3xl:rounded-[30px]">
                                <p className="text-[2.625rem] lg:text-5xl 2xl:text-6xl 3xl:text-7xl font-semibold text-[#ff3b00] w-full border-b border-black/30 pb-1 sm:pb-4 3xl:pb-5 tracking-[-0.02em] 3xl:leading-[90px]">
                                    {item.value}
                                </p>
                                <span className="text-2xl lg:text-lg 3xl:text-2xl font-semibold mt-3 sm:mt-5 3xl:mt-7 tracking-[-0.02em]">
                    ...
                    <ArrowNote
                        lines={renderArrowNoteLines(statsArrow)}
                        imageClassName="left-0 3xl:left-8 -top-16 3xl:-top-20 size-14! 3xl:size-20!"
                        curvePosition="end"
                        imageIndex={3}
                        curveFlipHorizontal={true}
            ...
            <div className="flex flex-col mt-20 lg:mt-65 3xl:mt-70 relative">
                <ArrowNote
                    lines={renderArrowNoteLines(traffic.arrowNote)}
                    imageClassName="right-8 top-18 3xl:top-24 3xl:w-9"
                    curvePosition="end"
                    curveFlipHorizontal={true}
                    curveFlipVertical={false}
                ...
                <div className="max-sm:px-2 sm:max-w-[90%] 3xl:max-w-[88%] sm:mx-auto w-full ">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 2xl:gap-10 mt-16 3xl:mt-14">
                        {traffic.cards.map((item, index) => (
                            <CutCornerBackground hideCutOnMobile={true} bgColor="#F9F9F9" key={index} cutWidth={20} cutHeight={20} cutRadius={1}>
                                <div className="p-4 max-lg:pt-10 md:p-6 lg:p-8 3xl:p-12.5 flex flex-col rounded md:rounded-2xl lg:rounded-3xl 3xl:rounded-[30px] justify-between max-md:bg-[#f9f9f9]">
                                    <div className="pb-10 lg:pb-6 3xl:pb-10 ">
                                        <span className="border border-[#ff3b00]/30 text-[#ff3b00] px-4 lg:px-2 3xl:px-4 py-3 lg:py-1 3xl:py-3 rounded-full uppercase lg:text-sm 3xl:text-base w-fit">
                                            {item.buttonText}
                                        </span>
            ...
            <div className="flex flex-col mt-30 lg:mt-50 3xl:mt-60 relative scroll-mt-30 3xl:scroll-mt-35" id='services'>
                <ArrowNote
                    lines={renderArrowNoteLines(services.arrowNote)}
                    imageClassName="left-16 3xl:left-20 top-20 3xl:top-24 scale-x-[-1] rotate-[20deg] 3xl:w-9"
                    curvePosition="end"
                    curveFlipHorizontal={true}
                    curveFlipVertical={false}
            ...
            <div className="flex flex-col mt-30 lg:mt-50 3xl:mt-60 relative scroll-mt-30 3xl:scroll-mt-35" id='process'>
                <ArrowNote
                    lines={renderArrowNoteLines(process.arrowNote)}
                    imageClassName="right-8 top-24 3xl:top-28 size-14! 3xl:size-20! scale-y-[-1] scale-x-[-1] rotate-[30deg]"
                    curvePosition="end"
                    curveFlipHorizontal={false}
                    curveFlipVertical={false}
            ...
            <div className="flex flex-col mt-70 lg:mt-50 3xl:mt-60 relative scroll-mt-30 3xl:scroll-mt-35" id='why-upthrust'>
                <ArrowNote
                    lines={renderArrowNoteLines(workingWithUs.arrowNote)}
                    imageClassName="left-20 2xl:left-12 top-20 3xl:top-26 scale-x-[-1] rotate-[20deg] size-16!"
                    curvePosition="end"
                    curveFlipHorizontal={true}
                    curveFlipVertical={false}
                ...
                <UiUxHeading
                    tag="h3"
                    heading={workingWithUs.heading}
                    label={workingWithUs.label}
                    subtitle={workingWithUs.subtitle}
                />
                <div className="max-sm:w-full sm:max-w-[90%] 3xl:max-w-[88%] sm:mx-auto max-sm:px-2 mt-10 lg:mt-20 3xl:mt-24">
                    <WorkingWithUs />
                </div>
                ...
                <div className="sm:max-w-[90%] 3xl:max-w-[88%] max-sm:px-2 sm:mx-auto w-full mt-0 3xl:mt-16">
                    ...
                    <div className="grid lg:grid-cols-5 mt-25 3xl:mt-40 max-lg:px-2">
                        <div className="lg:col-span-2">
                            ...
                            />
                            <div className="max-w-[200px] lg:max-w-[150px] 3xl:max-w-[200px] text-sm text-center mt-4">
                                <p className="uppercase">{portfolio.clutch.score}</p>
                                <span className="">{portfolio.clutch.reviewCount}</span>
                            </div>
                        </div>
                        <div className="lg:col-span-3 flex justify-end">
                            <p className="text-3xl 2xl:text-4xl 3xl:text-5xl font-semibold leading-10 3xl:leading-15 lg:w-[705px] 3xl:w-[954px] tracking-[-0.02em] max-lg:hidden">
                                {portfolio.testimonialsBlurb}
                            </p>
                            <p className="lg:hidden text-4xl font-semibold leading-11 tracking-[-0.02em] mt-5">
                                {portfolio.testimonialsBlurb}
                            </p>
            ...
            <div className="flex flex-col mt-30 lg:mt-50 3xl:mt-60 scroll-mt-30 3xl:scroll-mt-35" id='faqs'>
                <div className="sm:max-w-[90%] max-sm:px-2 sm:mx-auto relative">
                    <ArrowNote
                        lines={renderArrowNoteLines(faqArrow.arrowNote)}
                        imageClassName="right-4 3xl:right-12 top-20 3xl:top-26 scale-y-[-1] scale-x-[-1] size-14! 3xl:size-20!"
                        curvePosition="end"
                        curveFlipHorizontal={true}
                        curveFlipVertical={false}
